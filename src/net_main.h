...
#define TIMEOUT_WAIT_FOR_ALL_PLAYERS 15000
...
typedef TbBool (*NetworkFrameCompletionCheck)(void *server_buf, size_t frame_size);
typedef void (*NetworkYieldCallback)(void);
