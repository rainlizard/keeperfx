...
TbError LbNetwork_ExchangeServerNonBlocking(void *send_buf, void *server_buf, size_t buf_size);
TbError LbNetwork_ExchangeClientNonBlocking(void *send_buf, void *server_buf, size_t buf_size);
TbError LbNetwork_ExchangeNonBlocking(void *send_buf, void *server_buf, size_t buf_size);
